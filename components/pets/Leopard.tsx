...
export function Leopard({ mood = 'idle', size = 180 }: Props) {
  ...
  return (
    <Svg viewBox="0 0 200 200" width={size} height={size}>
      ...
      <Path d="M148 165 Q172 150 168 130 Q164 110 178 100"
        stroke="#D4A040" strokeWidth={12} fill="none" strokeLinecap="round" />
      <Path d="M148 165 Q172 150 168 130 Q164 110 178 100"
        stroke="#F0C060" strokeWidth={6} fill="none" strokeLinecap="round" opacity={0.4} />
